...
<head>
    ...
    <!-- SEO meta tags -->
    <title>Book a Meeting | Ganiam Tech</title>
    <meta name="description" content="Schedule a video meeting with our experts to discuss your ecommerce website project">
        ...
        <section class="d-flex align-items-center min-vh-80 bg-secondary px-3 py-5">
            <div class="container pt-2 shadow rounded-3">
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-8">
                        <h5 class="h4 mb-3 text-primary fw-bold text-center">Schedule a 30-minute Video Meeting with our Experts</h5>
                        
                        <p class="fs-sm text-center">The purpose of the meeting is to discuss details about your project and get all the information our team needs to make the perfect website for your business. </p>

                        <div class="meeting-container">
                            <!-- Calendly inline widget begin -->
                                <div class="calendly-inline-widget" data-url="https://calendly.com/ganiamtech/meeting-to-plan-your-website?hide_event_type_details=1&hide_gdpr_banner=1&primary_color=0aad0a" style="min-width:320px;height:700px;"></div>
