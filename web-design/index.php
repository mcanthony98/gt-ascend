...
<head>
  <meta charset="utf-8">
  <title>Ganiam Tech | Bringing Digital Solutions to your Business</title>
  <!-- SEO Meta Tags-->
  <meta name="description" content="We build websites and applications that help your business to stand out in the digital world.">
  ...
  <meta property="og:title" content="Ganiam Tech | Bringing Digital Solutions to your Business">
  <meta name="twitter:title" content="Ganiam Tech | Bringing Digital Solutions to your Business">

  <meta property="og:description" content="We build websites and applications that help your business to stand out in the digital world.">
  <meta name="twitter:description" content="We build websites and applications that help your business to stand out in the digital world.">
...
<body>
  ...
  <main class="page-wrapper">
      ...
      <div class="container d-flex justify-content-center pb-sm-3 py-md-4 py-xl-5">
        <div class="row align-items-center pt-5 mt-4 mt-xxl-0">
            ...
            <div class="parallax mx-auto mx-lg-0" style="max-width: 582px;">
              <div class="parallax-layer zindex-3" data-depth="0.1">
                <div class="position-relative mx-auto" style="max-width: 61%; padding: .3125rem; margin-bottom: 9.9%; background-color: #121519; border-radius: calc(var(--ar-border-radius) * 2.125);">
                  ...
                  <video class="d-block w-100" autoplay loop playsinline muted style="border-radius: calc(var(--ar-border-radius) * 1.875);">
                    <source src="assets/img/hero-vid-compressed.mp4" type="video/mp4">
                  </video>
                </div>
              </div>
          ...
          <div class="col-lg-6 text-center text-lg-start">
            <h1 class="display-2 pb-3 mb-4"><span class='fw-normal'>Grow Your Business with a </span> Website</h1>
            <div class="row row-cols-3">
              <div class="col"><i class="ai-bulb-alt d-block fs-1 text-dark mb-2 pb-1"></i>
                <p class="mb-0">Individual approach to your business</p>
              </div>
              <div class="col"><i class="ai-rocket d-block fs-2 text-dark mb-3"></i>
                <p class="mb-0">We guarantee results after a month</p>
              </div>
              <div class="col"><i class="ai-quotes d-block fs-3 text-dark mb-3"></i>
                <p class="mb-0">24/7 Customer Support</p>
              </div>
            </div>
            <div class="d-sm-flex justify-content-center justify-content-lg-start pt-5 mt-lg-2">
              <a class="btn btn-lg btn-primary w-100 w-sm-auto mb-2 mb-sm-0 me-sm-1" href="contact-us.php">Get a Professional Website Today</a>
              <a class="btn btn-lg btn-link" href="portfolio.php">View Our Portfolio<i class="ai-arrow-right ms-2"></i></a>
            </div>
          </div>
        </div>
      </div>
    ...
    <!-- About-->
    <section class="overflow-hidden pb-3 mb-lg-3 mb-xl-4 mb-xxl-5 mt-5 mb-5">
      <div class="container pb-sm-2 pb-md-3 pb-lg-5 mb-md-3 mb-lg-0">
        <!-- Parallax image-->
        <div class="position-relative mx-auto" style="max-width: 1198px;">
          <div class="position-relative zindex-3" data-aos="fade-left" data-aos-duration="600" data-aos-offset="300"><img src="assets/img/01.png" alt="a business person using a website"></div>
          <div class="position-absolute top-0 start-0 zindex-2" data-aos="fade-right" data-aos-duration="600" data-aos-offset="300"><img src="assets/img/02.png" alt="a successfull business"></div>
        ...
        <div class="row pt-5 mt-md-4">
          <div class="col-md-6 col-xxl-5 offset-xxl-1 mb-4 mb-md-0">
            <div class="text-center text-md-start pe-md-4 pe-xl-5 pe-xxl-0">
              <h2 class="h1 mb-sm-4">Whatever you do, can be done better with a website</h2>
              <p class="fs-lg mb-2 mb-sm-3 mb-xl-4 mx-auto mx-md-0" style="max-width: 475px;">Any business that you do, can grow faster with a webiste. Take your business online today by getting a professional website.</p>
              <a class="btn btn-lg btn-outline-primary mt-3" href="contact-us.php">Let's Discuss Your Business!<i class="ai-arrow-right ms-2"></i></a>
            </div>
          </div>
          <div class="col-md-6 mt-n3">
            <div class="row row-cols-2 row-cols-sm-3 row-cols-md-2 row-cols-lg-3 gy-md-2 gx-3 mt-4 mt-md-0">
              <div class="col mb-1">
              <a href="contact-us.php" >
                <div class="d-flex flex-column h-100 bg-faded-info rounded-3 text-center p-4">
                  <div class="h3 display-5 mt-1 mb-0"><i class="ai-plug"></i></div>
                  <div class="fs-lg mb-1" style="text-decoration: none; color: white;">Electronics Industry</div>
                </div>
                </a>
              </div>
              ...
              <a href="contact-us.php">
                <div class="d-flex flex-column h-100 bg-faded-danger rounded-3 text-center p-4">
                  <div class="h3 display-5 mt-1 mb-0"><i class="ai-flower"></i></div>
                  <div class="fs-lg mb-1" style="text-decoration: none; color: white;">Law Firm</div>
                </div>
              </a>
              </div>
              ...
              <div class="col mb-1">
              <a href="contact-us.php">
                <div class="d-flex flex-column h-100 bg-faded-dark rounded-3 text-center p-4">
                  <div class="h3 display-5 mt-1 mb-0"><i class="ai-canteen"></i></div>
                  <div class="fs-lg mb-1" style="text-decoration: none; color: white;">Restaurants</div>
                </div>
              </a>
              </div>

                <div class="col mb-1">
                  <a href="ecommerce.php" target="_blank" class="d-flex flex-column h-100  rounded-3 text-center p-4" style="background-color: #02112B">
                  <div class="h3 display-5 mt-1 mb-0"><i class="ai-cart"></i></div>
                  <div class="fs-lg mb-1" style="text-decoration: none; color: white;">E-commerce</div>
                  </a>
                </div>

              <div class="col mb-1">
              <a href="contact-us.php">
                <div class="d-flex flex-column h-100 bg-faded-success rounded-3 text-center p-4">
                  <div class="h3 display-5 mt-1 mb-0"><i class="ai-home"></i></div>
                  <div class="fs-lg mb-1" style="text-decoration: none; color: white;">Tours and Travel</div>
                </div>
                </a>
              </div>

              <div class="col mb-1">
               <div class="d-flex flex-column h-100 bg-primary rounded-3 text-center p-4">
                  <div class="h4 mt-1 mb-0"><a href="contact-us.php" class="link-light">Tell Us Your Business!</a>
                  <div class="h6 mt-1  mb-0 text-right"> <a href="contact-us.php" class="link-light" style="text-decoration:none;">click here</a>
                </div>
               </div>
              </div> 
    ...
    <section class="container py-5 mt-5 mb-lg-3 mb-xl-4 mb-xxl-5">
      <div class="text-center pb-3 pt-lg-2 pt-xl-4 my-1 my-sm-3 my-lg-4">
        <h3 class="display-3">Website Service Options</h3>
        <p class="fs-lg mb-0">Choose the service plan that fits your business needs</p>
      </div>

      <div class="row row-cols-2 flex-nowrap pb-4 gy-3 overflow-auto">

        <!-- Standard Website -->
        <div class="col" style="min-width: 19rem;">
          <div class="card border-primary bg-primary h-100 py-lg-6">
            <div class="card-body w-100 mx-auto text-center" style="max-width: 23rem;">
              <h3 class="text-light">Standard Website</h3>
              <div class="display-2 text-light mb-4">
                <i class="ai-globe"></i>
              </div>
              <p class="text-light opacity-70 mb-3">Get a professional website to showcase your business online.</p>
              <a class="d-inline-block text-light text-decoration-underline opacity-80 small mb-3" href="#" data-bs-toggle="modal" data-bs-target="#standardPricingModal">See pricing</a>
              <a href="contact-us.php?service=standard-website#contact-form" class="btn btn-light w-100">Get a Website Today</a>
            </div>
          </div>
        </div>
        ...
        <!-- Ecommerce Website -->
        <div class="col" style="min-width: 19rem;">
          <div class="card h-100 py-lg-6" style="background-color: #0aad0a;">
            <div class="card-body w-100 mx-auto text-center" style="max-width: 23rem;">
              <h3 class="text-light">E-commerce</h3>
              <div class="display-2 text-light mb-4">
                <i class="ai-cart"></i>
              </div>
              <p class="text-light opacity-70 mb-3">Start selling online with a full-featured ecommerce website.</p>
              <a class="d-inline-block text-light text-decoration-underline opacity-80 small mb-3" href="#" data-bs-toggle="modal" data-bs-target="#ecommercePricingModal">See pricing</a>
              <a href="contact-us.php?service=ecommerce-website#contact-form" class="btn btn-light w-100">Get an E-commerce Website</a>
            </div>
          </div>
        </div>
    ...
    <!-- Testimonials -->
    <section class="container py-5 my-5 d-none">
      <div class="text-center pb-3 pt-lg-2 pt-xl-3">
        <h3 class="display-5">What Our Clients Say</h3>
        <p class="fs-lg mb-0">Businesses trust us to deliver real results</p>
      </div>
    ...
    <section class="container py-5 my-md-2 my-lg-3 my-xl-4 my-xxl-5">
      <div class="row align-items-center py-1 py-sm-3 py-md-4 my-lg-2">
        <div class="col-lg-4 offset-xl-1">
          <h2 class="h1 text-center text-lg-start pb-3 pb-lg-1">Why you need a website!</h2>
          <!-- Show on screens > 992px-->
          <ul class="list-unstyled d-none d-lg-block pb-3 mb-3 mb-lg-4">
            <li class="d-flex pt-2"><i class="ai-check-alt fs-4 text-primary mt-n1 me-2"></i>Increase sales</li>
            <li class="d-flex pt-2"><i class="ai-check-alt fs-4 text-primary mt-n1 me-2"></i>Grow your brand</li>
            <li class="d-flex pt-2"><i class="ai-check-alt fs-4 text-primary mt-n1 me-2"></i>Beat your competitors</li>
          </ul><a class="btn btn-primary d-none d-lg-inline-flex" href="contact-us.php">Get a Website Today!</a>
        </div>
        <div class="col-lg-8 col-xl-7 col-xxl-6">
          <div class="row row-cols-1 row-cols-sm-2">
            <div class="col">
              <div class="card border-0 bg-faded-primary">
                <div class="card-body"><i class="ai-globe fs-1 text-primary d-block mb-3"></i>
                  <h3 class="h4">24/7 Accessibility</h3>
                  <p class="fs-sm">With a professional website, customers can find you at any time of the day. Our team ensures that your website is always accessible throughout the year.</p>
                </div>
              </div>
              <div class="card border-0 bg-faded-info mt-4">
                <div class="card-body"><i class="ai-bulb-alt fs-1 text-info d-block mb-3"></i>
                  <h3 class="h4">Showcase Your Work</h3>
                  <p class="fs-sm">You will grow your brand by showing your business to customers on your website. Customers are likely to trust you if you have a professional website.</p>
                </div>
              </div>
            </div>
            <div class="col pt-lg-3">
              <div class="card border-0 bg-faded-warning mt-4 mt-sm-0 mt-lg-4">
                <div class="card-body"><i class="ai-circle-check-filled fs-1 text-warning d-block mb-3"></i>
                  <h3 class="h4">Customer Engagement</h3>
                  <p class="fs-sm">You can talk to your customers through your website and increase your sales. Seamless communication between you and your customers is the key to increasing sales.</p>
                </div>
              </div>
              <div class="card border-0 bg-faded-danger mt-4">
                <div class="card-body"><i class="ai-rocket fs-2 text-danger d-block mb-3"></i>
                  <h3 class="h4">Competitive Advantage</h3>
                  <p class="fs-sm">A professional website will help your business stand-out from competitors.</p>
                </div>
              </div>
            </div>
          </div>
          <!-- Show button on screens < 992px-->
          <div class="d-lg-none text-center pt-3 mt-3 mt-sm-4"><a class="btn btn-primary" href="contact-us.php">Get a Website Today!</a></div>
        </div>
      </div>
    </section>
    ...
    <!-- Stats-->
    <section class="container py-5 mt-lg-3 mt-xl-4 mt-xxl-5 bg-faded-primary rounded-5">
      <div class="row pt-2 pt-sm-3 pt-md-4 pt-lg-5 pb-xxl-2 mt-md-3 mt-lg-0 ">
        <div class="col-lg-5 mb-5 mb-lg-0">
          <div class="h1 text-center text-lg-start pb-md-2 pb-xl-0 mb-4 mb-xl-5">There is endless possibilities for businesses to thrive in the online space. Take your chance today!</div>
          <div class="d-flex justify-content-center justify-content-lg-start">
            <a class="btn btn-primary btn-sm btn-lg me-3" href="contact-us.php">Get a Quote</a>
            <a class="btn btn-outline-dark btn-sm btn-lg " href="portfolio.php">Browse our portfolio</a>
          ...
          <div class="row row-cols-1 row-cols-sm-2 g-3 g-md-4">
            <div class="col">
              <div class="d-flex flex-column h-100 bg-faded-primary rounded-3 text-center p-4">
                <div class="h3 display-5 mt-1 mb-0">600+</div>
                <div class="fs-lg mb-1">Happy clients</div>
              </div>
            </div>
            <div class="col">
              <div class="d-flex flex-column h-100 bg-faded-info rounded-3 text-center p-4">
                <div class="h3 display-5 mt-1 mb-0">7</div>
                <div class="fs-lg mb-1">Countries</div>
              </div>
            </div>
            <div class="col">
              <div class="d-flex flex-column h-100 bg-faded-warning rounded-3 text-center p-4">
                <div class="h3 display-5 mt-1 mb-0">6</div>
                <div class="fs-lg mb-1">Years of experience</div>
              </div>
            </div>
            <div class="col">
              <div class="d-flex flex-column h-100 bg-faded-danger rounded-3 text-center p-4">
                <div class="h3 display-5 mt-1 mb-0">100+</div>
                <div class="fs-lg mb-1">Industries</div>
              </div>
            </div>
          </div>
        </div>
    ...
    <!-- Pricing Modals -->
    <div class="modal fade" id="standardPricingModal" tabindex="-1" aria-labelledby="standardPricingModalLabel" aria-hidden="true">
      <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title" id="standardPricingModalLabel">Standard Website Pricing</h5>
            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
          </div>
          <div class="modal-body">
            <div class="mb-5">
              <h6 class="fw-semibold text-primary mb-2">Quick Simple Website</h6>
              <p class="mb-2"><strong>Price:</strong> KES 9,999</p>
              <ul class="list-unstyled mb-3">
                <li class="d-flex mb-2"><i class="ai-check-alt text-primary me-2"></i><span>Get your website in 12 hours.</span></li>
                <li class="d-flex mb-2"><i class="ai-check-alt text-primary me-2"></i><span>For quick production. Go online immediately.</span></li>
                <li class="d-flex mb-2"><i class="ai-check-alt text-primary me-2"></i><span>Domain name.</span></li>
                <li class="d-flex mb-2"><i class="ai-check-alt text-primary me-2"></i><span>1 yr hosting.</span></li>
              </ul>
              <a class="btn btn-primary" href="contact-us.php?service=quick-simple-website#contact-form">Get my website now</a>
              <p class="small text-muted mt-2 mb-0">10k annual maintenance fee starting 2nd year.</p>
            </div>
            <div>
              <h6 class="fw-semibold text-primary mb-2">Custom Website</h6>
              <p class="mb-2"><strong>Starting from:</strong> KES 19,999</p>
              <ul class="list-unstyled mb-3">
                <li class="d-flex mb-2"><i class="ai-check-alt text-primary me-2"></i><span>Price varies based on features.</span></li>
                <li class="d-flex mb-2"><i class="ai-check-alt text-primary me-2"></i><span>Speak to the designer on chat.</span></li>
                <li class="d-flex mb-2"><i class="ai-check-alt text-primary me-2"></i><span>Give feedback on design before publishing.</span></li>
                <li class="d-flex mb-2"><i class="ai-check-alt text-primary me-2"></i><span>Admin portal to update website content.</span></li>
                <li class="d-flex mb-2"><i class="ai-check-alt text-primary me-2"></i><span>Up to 5 days development time.</span></li>
                <li class="d-flex mb-2"><i class="ai-check-alt text-primary me-2"></i><span>Domain name.</span></li>
                <li class="d-flex mb-2"><i class="ai-check-alt text-primary me-2"></i><span>1 yr hosting.</span></li>
              </ul>
              <a class="btn btn-primary" href="contact-us.php?service=custom-website-quote#contact-form">Get your free quote</a>
              <p class="small text-muted mt-2 mb-0">10k annual maintenance fee starting 2nd year.</p>
            </div>
          </div>
        </div>
    ...
    <div class="modal fade" id="ecommercePricingModal" tabindex="-1" aria-labelledby="ecommercePricingModalLabel" aria-hidden="true">
      <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title" id="ecommercePricingModalLabel">E-commerce Pricing</h5>
            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
          </div>
          <div class="modal-body">
            <div class="mb-5">
              <h6 class="fw-semibold text-success mb-2">Quick E-commerce</h6>
              <p class="mb-2"><strong>Price:</strong> KES 9,999</p>
              <ul class="list-unstyled mb-3">
                <li class="d-flex mb-2"><i class="ai-check-alt text-success me-2"></i><span>Quick production with 12 hrs.</span></li>
                <li class="d-flex mb-2"><i class="ai-check-alt text-success me-2"></i><span>Get customer enquiries to WhatsApp.</span></li>
                <li class="d-flex mb-2"><i class="ai-check-alt text-success me-2"></i><span>No payment integration i.e., M-Pesa or card.</span></li>
                <li class="d-flex mb-2"><i class="ai-check-alt text-success me-2"></i><span>Domain name.</span></li>
                <li class="d-flex mb-2"><i class="ai-check-alt text-success me-2"></i><span>1 yr free hosting.</span></li>
              </ul>
              <a class="btn btn-success" href="contact-us.php?service=quick-ecommerce#contact-form">Get started</a>
              <p class="small text-muted mt-2 mb-0">10k annual maintenance fee starting 2nd year.</p>
            </div>
            <div>
              <h6 class="fw-semibold text-success mb-2">Full E-commerce</h6>
              <p class="mb-2"><strong>Price:</strong> KES 19,999</p>
              <ul class="list-unstyled mb-3">
                <li class="d-flex mb-2"><i class="ai-check-alt text-success me-2"></i><span>Includes all Quick E-commerce features.</span></li>
                <li class="d-flex mb-2"><i class="ai-check-alt text-success me-2"></i><span>Integrated payments with M-Pesa and cards.</span></li>
              </ul>
              <a class="btn btn-success" href="contact-us.php?service=full-ecommerce#contact-form">Start selling online</a>
              <p class="small text-muted mt-2 mb-0">10k annual maintenance fee starting 2nd year.</p>
            </div>
          </div>
        </div>
